...
class AppLocalizations {
  ...
  String get categoryTakeProfit => translate('categoryTakeProfit');
  String get categoryOther => translate('categoryOther');
  String get customCategoryLabel => translate('customCategoryLabel');
  ...
  String get firmAccount => translate('firmAccount');
  String get firmAccountAvailable => translate('firmAccountAvailable');
  String get firmAccountTotalInvested => translate('firmAccountTotalInvested');
  String get firmAccountNote => translate('firmAccountNote');
  String get totalDeposits => translate('totalDeposits');
  String get depositHistory => translate('depositHistory');
  String get noDeposits => translate('noDeposits');
  String get addDeposit => translate('addDeposit');
  String get subtractDeposit => translate('subtractDeposit');
  String get depositAmount => translate('depositAmount');
  String get transactionHistory => translate('transactionHistory');
  String get deleteDepositMessage => translate('deleteDepositMessage');
